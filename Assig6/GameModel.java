...
public class GameModel {
   ...
   protected static void updateScore(int score)
   {
      ...
      {
         Assig6.playerScores[Assig6.COMPUTER_PLAYER1] += 2;
         Assig6.playLabelText[Assig6.COMPUTER_PLAYER1].setText("Computer's Score: " + Assig6.playerScores[Assig6.COMPUTER_PLAYER1]);
      }
      else if(score == 1) //player wins
      {
         Assig6.playerScores[Assig6.HUMAN_PLAYER1] +=2;
         Assig6.playLabelText[Assig6.HUMAN_PLAYER1].setText("Player's Score: " + Assig6.playerScores[Assig6.HUMAN_PLAYER1]);
      }
      else if (score == 0) //tie
      {
         Assig6.playLabelText[Assig6.COMPUTER_PLAYER1].setText("Computer's Score: " + ++Assig6.playerScores[Assig6.COMPUTER_PLAYER1]);
...
protected static int comPlay(Hand comHand, Card playedCard)
{
 ...
 //inner class CardGameFramework  ----------------------------------------------------
   static class CardGameFramework extends GameModel
   {
 ...
 //inner Card class represents a single playing card consisting of a suit and a value (Ex. Ace of Spades).
   static class Card
   {
    //Holds the suit data
   ...
   //inner Deck class represents the source of playing cards that the players are pulling cards from.
   static class Deck
   {
    //Member variables
